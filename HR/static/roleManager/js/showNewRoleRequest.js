...
$(document).ready(function () {
  // بخش تغییر رفتار آیکون های نوع سمت
  ...
  // بخش تغییر رفتار آیکون های مدیر مربوطه
  $(".relevantManagerIcon").each(function () {
    $(this).on("mouseenter", function () {
      if($(this).attr("isClicked") == "false" && $(this).attr("isDisabled") == "false"){
        const iconName = $(this).data("iconname");
        const address = $(this).data("staticaddress");
        $(this).attr("src", `${address}/${iconName}_hover_icon.png`);
      }
  ...
  // اگر نوع سمت سایرین انتخاب شده بود باکس اسمشو نشون میده
  if ($("#otherRoleTypeIcon").attr("isClicked") == "true") {
    $("#roleTypeInputContainer").css("display", "flex");
    $("#roleTypeInputContainer").find("input").attr("isvisible", "true");
  }
});
...
$(document).ready(function () {
  if (
    $("#hasSuperior_yes_image").attr("isDisabled") == "false" &&
    $("#hasLevel_yes_image").attr("isDisabled") == "false"
  ) {
    // دکمه بله ارشد دارد
...
$(document).ready(function () {
  if ($("#topSide_button").attr("isDisabled") == "false") {
    ...
    $("#conditionsPlusIcon").click(function () {
      ...
      if (textCard_title == "") {
        ...
        if (isDuplicated) {
          ...
          let textCard = createTextCard(
            (text = textCard_title),
            (cardClass = "conditionsText")
          );
          textCard
            .hide()
...
$(document).ready(function () {
  $(".bottomSection_input, #roleTitleInput, #roleTypeTitleInput").on(
    "keypress",
    function (e) {
...
function readOnly_Mode() {
  ...
  $(".fa-trash-can").attr("isDisabled", "true").css("cursor", "not-allowed");

  // غیر فعال کردن آیکون های نوع سمت و مدیر مربوطه
  $(".circleIcon").attr("isDisabled", "true").css("cursor", "not-allowed");
}
